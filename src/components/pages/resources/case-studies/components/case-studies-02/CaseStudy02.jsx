...
import img1 from "../../../../../../assets/case-studies/2.png";
    ...
    <div className="bg-white min-h-screen mt-16 px-4 sm:px-8 lg:px-16 flex flex-col items-center">
      <div className="w-full max-w-4xl p-8">
        ...
        <h2 className="text-black text-3xl sm:text-4xl font-medium mb-2">
          The Evolution and Impact of Artificial Intelligence (AI) on Global
          Markets
        </h2>
        <p className="mb-4">
          <MarkdownViewer url="https://raw.githubusercontent.com/consortium-analytics/Consortium-Analytics-Assets/main/case-studies-asset/markdown-files/case-study-02/case-study-02.md" />
        </p>
      </div>
