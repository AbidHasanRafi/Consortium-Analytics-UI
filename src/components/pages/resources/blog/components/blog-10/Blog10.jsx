    ...
    <div className="bg-white min-h-screen mt-16 px-4 sm:px-8 lg:px-16 flex flex-col items-center">
      <div className="w-full max-w-4xl p-4 sm:p-6 lg:p-8">
        ...
        <h2 className="text-black text-2xl sm:text-3xl lg:text-4xl font-medium mb-2">
          Power BI vs. Looker Studio vs. Tableau: A Comprehensive Comparison
        </h2>
        <p className="mb-4">
          <MarkdownViewer url="https://raw.githubusercontent.com/consortium-analytics/Consortium-Analytics-Assets/main/blogs-asset/markdown-files/blog-10/blog-10.md" />
        </p>
      </div>
