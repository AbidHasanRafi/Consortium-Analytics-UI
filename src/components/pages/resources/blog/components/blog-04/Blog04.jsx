...
import img1 from "../../../../../../assets/blogs/header/4.png";
  ...
  return (
    <div className="bg-white min-h-screen mt-16 px-4 sm:px-8 lg:px-16 flex flex-col items-center">
      <div className="w-full max-w-4xl p-4 sm:p-6 lg:p-8">
        ...
        <h2 className="text-black text-2xl sm:text-3xl lg:text-4xl font-medium mb-2">
          Unlocking Insights with Data Visualization Tools: Power BI, Tableau,
          and Google Looker Studio
        </h2>
        <p className="mb-4">
          <MarkdownViewer url="https://raw.githubusercontent.com/consortium-analytics/Consortium-Analytics-Assets/main/blogs-asset/markdown-files/blog-04/blog-04.md" />
        </p>
      </div>

      {/* Request a Demo Section */}
      <div className="bg-indigo-700 text-white w-full py-6 sm:py-8 lg:py-10 px-6 sm:px-8 lg:px-8 rounded-lg flex items-center justify-between mt-8 sm:mt-10 lg:mt-10 max-w-4xl">
        <h1 className="text-lg sm:text-xl lg:text-2xl font-medium text-left max-w-xl leading-7">
