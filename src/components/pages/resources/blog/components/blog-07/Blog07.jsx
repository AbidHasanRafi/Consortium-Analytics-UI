  ...
  return (
    <div className="bg-white min-h-screen mt-16 px-4 sm:px-8 lg:px-16 flex flex-col items-center">
      <div className="w-full max-w-4xl p-8">
        ...
        <p className="mb-4">
          <MarkdownViewer url="https://raw.githubusercontent.com/consortium-analytics/Consortium-Analytics-Assets/main/blogs-asset/markdown-files/blog-07/blog-07.md" />
        </p>
      </div>
