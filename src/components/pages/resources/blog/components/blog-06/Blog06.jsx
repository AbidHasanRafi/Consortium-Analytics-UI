...
import img1 from "../../../../../../assets/blogs/header/6.png";
...
const Blog06 = () => {
  ...
  return (
    <div className="bg-white min-h-screen mt-16 px-4 md:px-16 flex flex-col items-center">
      <div className="w-full max-w-4xl p-8">
        ...
        <h2 className="text-black text-3xl md:text-4xl font-medium mb-2">
          Harnessing the Power of AI and Machine Learning in Business Analytics
        </h2>
        <p className="mb-4">
          <MarkdownViewer url="https://raw.githubusercontent.com/consortium-analytics/Consortium-Analytics-Assets/main/blogs-asset/markdown-files/blog-01/blog-01.md" />
        </p>
      </div>

      {/* Request a Demo Section */}
      <div className="bg-indigo-700 text-white w-full py-10 px-8 rounded-lg flex flex-col sm:flex-row items-center justify-between mt-10 max-w-4xl">
        <h1 className="text-xl md:text-2xl font-medium text-left max-w-xl leading-7 mb-4 sm:mb-0">
