...
import img1 from "../../../../../../assets/blogs/header/3.png";
  ...
  return (
    <div className="bg-white min-h-screen mt-16 px-4 sm:px-8 lg:px-16 flex flex-col items-center">
      <div className="w-full max-w-4xl p-4 sm:p-8">
        ...
        <p className="mb-4">
          <MarkdownViewer url="https://raw.githubusercontent.com/consortium-analytics/Consortium-Analytics-Assets/main/blogs-asset/markdown-files/blog-03/blog-03.md" />
        </p>
      </div>

      {/* Request a Demo Section */}
      <div className="bg-indigo-700 text-white w-full py-8 sm:py-10 px-4 sm:px-8 rounded-lg flex flex-col sm:flex-row items-center justify-between mt-10 max-w-4xl">
        <h1 className="text-xl sm:text-2xl font-medium text-left max-w-xl leading-7 mb-4 sm:mb-0">
