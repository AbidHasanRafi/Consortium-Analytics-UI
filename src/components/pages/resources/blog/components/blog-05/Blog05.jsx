...
import img1 from "../../../../../../assets/blogs/header/5.png";
...
const Blog05 = () => {
  ...
  return (
    <div className="bg-white min-h-screen mt-16 px-4 sm:px-8 md:px-16 flex flex-col items-center">
      <div className="w-full max-w-4xl p-4 sm:p-8">
        ...
        <p className="mb-4">
          <MarkdownViewer url="https://raw.githubusercontent.com/consortium-analytics/Consortium-Analytics-Assets/main/blogs-asset/markdown-files/blog-05/blog-05.md" />
        </p>
      </div>

      {/* Request a Demo Section */}
      <div className="bg-indigo-700 text-white w-full py-8 sm:py-10 px-6 sm:px-8 rounded-lg flex items-center justify-between mt-10 max-w-4xl">
        <h1 className="text-lg sm:text-xl md:text-2xl font-medium text-left max-w-xl leading-7">
