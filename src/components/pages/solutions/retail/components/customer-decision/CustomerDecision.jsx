...
import img from "../../../../../../assets/pages/retail/customer-decision.jpg";
          ...
          <div className="bg-white col-span-1 lg:col-span-5 flex flex-col justify-center px-6 sm:px-8 lg:px-14 py-8 sm:py-12 order-2 lg:order-1">
            <section className="mx-0 lg:mx-16 my-12">
              ...
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                We delve deep into our customer preferences with insights into
                by identifing trends in how customers transact, differentiating
                between active and churned customers to improve loyalty
                strategies, and understanding demographics and behaviors to
                refine targeting.
              </p>
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                Our customers are the heart of our business, our dashboard
