...
import img from "../../../../../../assets/pages/retail/supply-chain.jpg";
          ...
          <div className="bg-white col-span-5 flex flex-col justify-center px-6 sm:px-8 lg:px-14 py-8 sm:py-12">
            <section className="mx-0 lg:mx-16 my-12">
              ...
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                Optimize operations with data-driven insights into logistics
                performance, customer behavior, and market trends. Consortium
                Analytics provides the tools you need to streamline logistics,
                reduce costs, and improve customer satisfaction.
              </p>
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                With actionable intelligence, meet customer demands faster and
                more cost-effectively. Our platform helps you make informed
