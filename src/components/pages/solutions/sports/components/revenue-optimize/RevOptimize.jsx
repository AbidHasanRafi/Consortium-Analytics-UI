...
import img from "../../../../../../assets/pages/sports/revenue-optimize.jpg";
          ...
          <div className="bg-white col-span-1 lg:col-span-5 flex flex-col justify-center px-6 sm:px-8 lg:px-14 py-8 sm:py-12 order-2 lg:order-1">
            <section className="mx-0 lg:mx-16 my-12">
              ...
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                From ticket pricing to sponsorship impact analysis, our
                solutions track and visualize financial data to maximize
                profitability. Our revenue optimization strategies help sports
                organizations identify new revenue streams, improve existing
                ones, and make data-driven decisions that boost the bottom line.
              </p>
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                Gain insights into key revenue streams and make informed
                decisions to improve financial outcomes.
              </p>
