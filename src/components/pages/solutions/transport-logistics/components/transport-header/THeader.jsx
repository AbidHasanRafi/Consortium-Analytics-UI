        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="text-white text-justify lg:order-1">
            ...
            <p className="text-base sm:text-lg text-slate-300 mb-4 leading-relaxed">
              Efficiency in transport and logistics is powered by insights. Our
              business analytics, data visualization, and actionable insights
              ensure seamless operations, optimized routes, and better
