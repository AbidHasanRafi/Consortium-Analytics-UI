...
import img from "../../../../../../assets/pages/transport/logistics-analytics.jpg";
          ...
          <div className="bg-white col-span-1 lg:col-span-5 flex flex-col justify-center px-6 sm:px-8 lg:px-14 py-8 sm:py-12 order-2 lg:order-1">
            <section className="mx-0 lg:mx-16 my-12">
              ...
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                Managing complex logistics operations requires clear visibility
                into key performance indicators. Our analytics platform provides
                the insights you need to optimize routes, reduce costs, and
                improve customer satisfaction.
              </p>
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                Our data visualization services consolidate diverse datasets
                into intuitive dashboards, helping businesses monitor
                operations, reduce costs, and enhance delivery performance
