...
import img from "../../../../../../assets/pages/transport/supply-chain.jpg";
          ...
          <div className="bg-white col-span-1 lg:col-span-5 flex flex-col justify-center px-6 sm:px-8 lg:px-14 py-8 sm:py-12 order-2 lg:order-1">
            <section className="mx-0 lg:mx-16 my-12">
              ...
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                Gain deeper insights into your supply chain performance with
                tailored analytics. Our platform provides real-time visibility
                into your supply chain operations, enabling you to make
                data-driven decisions and optimize your supply chain
                performance.
              </p>
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                From inventory tracking to order fulfillment rates, our
                solutions empower businesses to identify bottlenecks, improve
                warehouse efficiency, and ensure smooth delivery operations.
              </p>
