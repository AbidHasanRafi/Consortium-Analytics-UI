        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="text-white lg:order-1">
            ...
            <p className="text-base sm:text-lg text-slate-300 mb-4 leading-relaxed">
              In the ever-evolving field of education, data-driven decisions are
              key to improving student outcomes, optimizing resources, and
              enhancing learning experiences. Our services help educational
              institutions leverage student insights, performance tracking, and
              curriculum planning to improve overall effectiveness. With
              advanced analytics, AI, and business intelligence, we empower
              educators to make informed decisions that foster academic success
