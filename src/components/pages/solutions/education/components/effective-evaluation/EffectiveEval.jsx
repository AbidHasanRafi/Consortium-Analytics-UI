...
import img from "../../../../../../assets/pages/education/effect-eval.jpg";
          ...
          <div className="bg-white col-span-5 flex flex-col justify-center px-6 sm:px-8 lg:px-14 py-8 sm:py-12">
            <section className="mx-0 lg:mx-16 my-12">
              ...
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                Evaluate the impact of educational programs and initiatives with
                data-backed insights. Our platform helps you measure the
                effectiveness of your programs, identify areas for improvement,
                and make data-driven decisions to enhance student outcomes.
              </p>
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                From curriculum development to extracurricular activities, our
                analytics provide clarity on what works and how to improve,
                driving success for both educators and learners.
              </p>
