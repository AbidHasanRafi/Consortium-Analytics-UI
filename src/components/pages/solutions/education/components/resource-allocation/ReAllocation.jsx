...
import img from "../../../../../../assets/pages/education/re-allocate.jpg";
          ...
          <div className="bg-white col-span-5 flex flex-col justify-center px-6 sm:px-8 lg:px-14 py-8 sm:py-12">
            <section className="mx-0 lg:mx-16 my-12">
              ...
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                Maximize the impact of your budget and resources by leveraging
                data-driven insights. We help you identify the most effective
                strategies to allocate your resources and optimize your
                marketing and sales performance.
              </p>
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                Our analytics tools help educational institutions allocate
                funding, staff, and materials efficiently, ensuring optimal
