...
import img from "../../../../../../assets/pages/education/performance-insights.jpg";
import { HiArrowLongRight } from "react-icons/hi2";

const PerformInsights = () => {
  return (
          ...
          <div className="bg-white col-span-1 lg:col-span-5 flex flex-col justify-center px-6 sm:px-8 lg:px-14 py-8 sm:py-12 order-2 lg:order-1">
            <section className="mx-0 lg:mx-16 my-12">
              ...
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                Understand academic trends and challenges with comprehensive
                student performance analysis. Our platform enables you to track
                student performance, gain insights into student progress to
                address learning gaps, and Analyze student performance to guide
                instructional decisions.
              </p>
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                Our solutions identify areas for improvement, track progress,
                and help design targeted intervention strategies to support
...
export default PerformInsights;
