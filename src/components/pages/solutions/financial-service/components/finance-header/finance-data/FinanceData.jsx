...
import img from "../../../../../../../assets/pages/finance-services/finance-data.jpg";
          ...
          <div className="bg-white col-span-5 flex flex-col justify-center px-6 sm:px-8 lg:px-14 py-8 sm:py-12">
            <section className="mx-0 lg:mx-16 my-12">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 text-left">
                A Complete Financial Data Ecosystem
              </h2>
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                Leverage curated datasets to gain a comprehensive view of your
                financial landscape. Our platform simplifies data selection and
                analysis, offering insights into revenue trends, expense
                allocation, and channel-specific performance metrics.
              </p>
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                Make smarter, faster decisions with a data-driven approach to
                financial management. Our platform integrates seamlessly with
                your existing systems, providing real-time updates and
                actionable insights to drive growth and profitability.
              </p>
