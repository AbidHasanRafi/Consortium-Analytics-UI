...
import img from "../../../../../../assets/pages/finance-services/max-efficiency.jpg";
          ...
          <div className="bg-white col-span-1 lg:col-span-5 flex flex-col justify-center px-6 sm:px-8 lg:px-14 py-8 sm:py-12 order-2 lg:order-1">
            <section className="mx-0 lg:mx-16 my-12">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 text-left">
                Maximize Efficiency with Strategic Budgeting
              </h2>
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                Gain a deeper understanding of cost drivers with expense group
                analysis. Our dashboard empowers clients to manage budgets by
                tracking COGS, Opex, and other categories, ensuring resources
                are allocated effectively.
              </p>
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                Optimize expenditures and create strategic plans that align with
                your business goals. Our platform provides the insights needed
