        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="text-white lg:order-1">
            ...
            <p className="text-base sm:text-lg text-slate-300 mb-4 leading-relaxed">
              In the ever-evolving healthcare industry, data-driven decisions
              are key to improving patient care, optimizing resources, and
              enhancing operational efficiency. We offer a comprehensive suite
              of services, including facility planning, patient analytics, and
              outcomes optimization, to help healthcare providers deliver better
              care while maximizing efficiency. By leveraging AI, machine
              learning, and business intelligence, we enable hospitals and
              healthcare organizations to make informed, data-backed decisions
              that improve both clinical and financial outcomes.
            </p>
