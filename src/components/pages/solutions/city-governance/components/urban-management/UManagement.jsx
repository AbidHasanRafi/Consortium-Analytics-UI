...
import img from "../../../../../../assets/pages/city/urban-management.jpg";
          ...
          <div className="bg-white col-span-1 lg:col-span-5 flex flex-col justify-center px-6 sm:px-8 lg:px-14 py-8 sm:py-12 order-2 lg:order-1">
            <section className="mx-0 lg:mx-16 my-12">
              ...
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                Effective governance relies on understanding complex urban data.
                We help city authorities consolidate and visualize data from
                multiple sources, providing insights to optimize public
                services, monitor resource allocation, and ensure transparency.
              </p>
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                Our solutions enable you to track service performance, monitor
                citizen feedback, and analyze operational data to improve urban
                management.
              </p>
