...
import img from "../../../../../../assets/pages/city/engage-performance.jpg";
          ...
          <div className="bg-white col-span-5 flex flex-col justify-center px-6 sm:px-8 lg:px-14 py-8 sm:py-12">
            <section className="mx-0 lg:mx-16 my-12">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 text-left">
                Engaging Citizens Through Data
              </h2>
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                Strengthen citizen engagement by sharing key insights through
                intuitive visualizations. By presenting data transparently,
                governments can foster trust, encourage public participation,
                and make more inclusive decisions for the community.
              </p>
              <p className="text-gray-900 text-justify text-lg sm:text-xl">
                With our solutions, you can create interactive dashboards,
                publish performance metrics, and share urban data with citizens.
                Empower residents to contribute to city planning, provide
                feedback on services, and engage with local government.
              </p>
