...
import img from "../../../../../../assets/pages/analyze/analyze.png";
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="text-white lg:order-1">
            ...
            <p className="text-base sm:text-lg text-slate-300 mb-4 leading-relaxed">
              Analytics plays a crucial role in helping organizations make
              data-driven decisions by analyzing past and current data to
              uncover trends and patterns. Our analytics services allow
              businesses to extract actionable insights that guide strategy,
              optimize operations, and improve performance. With a variety of
              analytical techniques, we provide the tools you need to make
              informed, impactful decisions that drive business growth and
